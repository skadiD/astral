...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 442949411;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<BigInt> crateApiAstralWfpWfpControllerAddNetworkFilter({
    required WfpController that,
  ...
  Future<List<Guid>> crateApiAstralWfpWfpControllerGetLayersForRule({
    required WfpController that,
    required FilterRule rule,
  });
  ...
  FilterRule crateApiAstralWfpCreateFilterRule({required String name});
  ...
  WfpController crateApiAstralWfpCreateWfpController();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<BigInt> crateApiAstralWfpWfpControllerAddNetworkFilter({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAstralWfpWfpControllerAddNetworkFilterConstMeta,
        argValues: [that, rule, layerKey],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiAstralWfpWfpControllerAddNetworkFilterConstMeta =>
      const TaskConstMeta(
        debugName: "WfpController_add_network_filter",
        argNames: ["that", "rule", "layerKey"],
      );
  ...
  Future<List<Guid>> crateApiAstralWfpWfpControllerGetLayersForRule({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData:
              sse_decode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerGUID,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiAstralWfpWfpControllerGetLayersForRuleConstMeta,
        argValues: [that, rule],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAstralWfpWfpControllerGetLayersForRuleConstMeta =>
      const TaskConstMeta(
        debugName: "WfpController_get_layers_for_rule",
        argNames: ["that", "rule"],
      );
  ...
  FilterRule crateApiAstralWfpCreateFilterRule({required String name}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiAstralWfpCreateFilterRuleConstMeta,
        argValues: [name],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAstralWfpCreateFilterRuleConstMeta =>
      const TaskConstMeta(debugName: "create_filter_rule", argNames: ["name"]);
  ...
  WfpController crateApiAstralWfpCreateWfpController() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiAstralWfpCreateWfpControllerConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAstralWfpCreateWfpControllerConstMeta =>
      const TaskConstMeta(debugName: "create_wfp_controller", argNames: []);
  ...
  @protected
  List<Guid>
  dco_decode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerGUID(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerGUID(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as GuidImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  @protected
  void
  sse_encode_list_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerGUID(
    List<Guid> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
...
class WfpControllerImpl extends RustOpaque implements WfpController {
  ...
  Future<BigInt> addNetworkFilter({
    required FilterRule rule,
    required Guid layerKey,
  }) => RustLib.instance.api.crateApiAstralWfpWfpControllerAddNetworkFilter(
    that: this,
    rule: rule,
    layerKey: layerKey,
  );
  ...
  Future<List<Guid>> getLayersForRule({required FilterRule rule}) => RustLib
      .instance
      .api
      .crateApiAstralWfpWfpControllerGetLayersForRule(that: this, rule: rule);
