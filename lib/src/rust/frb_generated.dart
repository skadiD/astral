...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -640206954;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<GUID> crateApiAstralWfpGuidZeroed();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<GUID>> crateApiAstralWfpWfpControllerGetLayersForRule({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_guid,
          decodeErrorData: null,
        ),
  ...
  Future<GUID> crateApiAstralWfpGuidZeroed() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_guid,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiAstralWfpGuidZeroedConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAstralWfpGuidZeroedConstMeta =>
      const TaskConstMeta(debugName: "guid_zeroed", argNames: []);
  ...
  @protected
  List<GUID> dco_decode_list_guid(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_guid).toList();
  }
  ...
  @protected
  List<GUID> sse_decode_list_guid(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <GUID>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_guid(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  void sse_encode_list_guid(List<GUID> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_guid(item, serializer);
    }
  }
