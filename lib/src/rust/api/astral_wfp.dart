...
// These functions are ignored because they are not marked as `pub`: `action`, `add_filters_non_windows`, `app_path`, `cleanup_non_windows`, `delete_filters_non_windows`, `description`, `direction`, `get_layers_for_rule`, `initialize_non_windows`, `local_ip`, `local_port_range`, `local_port`, `priority`, `protocol`, `remote_ip`, `remote_port_range`, `remote_port`
