...
import 'package:astral/screens/room_config_form_page.dart';
...
class _RoomPageState extends State<RoomPage> {
  ...
  /// 导航到房间配置表单页面
  Future<void> _navigateToRoomConfigForm({RoomConfig? roomConfig, int? index}) async {
    final result = await Navigator.push<RoomConfig>(
      context,
      MaterialPageRoute(
        builder: (context) => RoomConfigFormPage(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              final currentConfigs = List<RoomConfig>.from(_roomState.roomConfig.value);
