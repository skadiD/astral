...
fn wire__crate__api__astral_wfp__WfpController_add_network_filter_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "WfpController_add_network_filter",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_rule = <RustOpaqueMoi<
                flutter_rust_bridge::for_generated::RustAutoOpaqueInner<FilterRule>,
            >>::sse_decode(&mut deserializer);
            let api_layer_key = <GUID>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        ...
                        let output_ok = crate::api::astral_wfp::WfpController::add_network_filter(
                            &*api_that_guard,
                            &*api_rule_guard,
                            api_layer_key,
                        )?;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        52 => wire__crate__api__astral_wfp__WfpController_add_network_filter_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        55 => wire__crate__api__astral_wfp__WfpController_cleanup_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        56 => wire__crate__api__astral_wfp__WfpController_delete_filters_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        57 => wire__crate__api__astral_wfp__WfpController_get_layer_name_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        58 => wire__crate__api__astral_wfp__WfpController_get_layers_for_rule_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        59 => wire__crate__api__astral_wfp__WfpController_initialize_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        53 => wire__crate__api__astral_wfp__WfpController_auto_accessor_get_filter_ids_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        54 => wire__crate__api__astral_wfp__WfpController_auto_accessor_set_filter_ids_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
