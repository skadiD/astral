...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1334741360;
...
fn wire__crate__api__astral_wfp__WfpController_get_layers_for_rule_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "WfpController_get_layers_for_rule",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    ...
                    for i in decode_indices_ {
                        match i {
                            0 => api_that_guard = Some(api_that.lockable_decode_sync_ref()),
                            1 => api_rule_guard = Some(api_rule.lockable_decode_sync_ref()),
                            _ => unreachable!(),
                        }
                    }
                    let api_that_guard = api_that_guard.unwrap();
                    let api_rule_guard = api_rule_guard.unwrap();
                    let output_ok = Result::<_, ()>::Ok(
                        crate::api::astral_wfp::WfpController::get_layers_for_rule(
                            &*api_that_guard,
                            &*api_rule_guard,
                        ),
                    )?;
...
impl SseDecode for Vec<GUID> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = vec![];
        for idx_ in 0..len_ {
            ans_.push(<GUID>::sse_decode(deserializer));
        }
        return ans_;
    }
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        57 => wire__crate__api__astral_wfp__WfpController_get_layers_for_rule_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        58 => wire__crate__api__astral_wfp__WfpController_initialize_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        60 => wire__crate__api__simple__close_server_impl(port, ptr, rust_vec_len, data_len),
        61 => wire__crate__api__simple__create_server_impl(port, ptr, rust_vec_len, data_len),
        62 => wire__crate__api__simple__easytier_version_impl(port, ptr, rust_vec_len, data_len),
        63 => wire__crate__api__hops__get_all_interfaces_metrics_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        66 => wire__crate__api__simple__get_network_status_impl(port, ptr, rust_vec_len, data_len),
        67 => wire__crate__api__nt__get_nt_path_impl(port, ptr, rust_vec_len, data_len),
        68 => {
            wire__crate__api__simple__get_peer_route_pairs_impl(port, ptr, rust_vec_len, data_len)
        }
        69 => wire__crate__api__simple__get_running_info_impl(port, ptr, rust_vec_len, data_len),
        70 => wire__crate__api__simple__handle_event_impl(port, ptr, rust_vec_len, data_len),
        71 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        72 => wire__crate__api__simple__is_easytier_running_impl(port, ptr, rust_vec_len, data_len),
        73 => {
        ...
        75 => wire__crate__api__hops__set_interface_metric_impl(port, ptr, rust_vec_len, data_len),
        76 => wire__crate__api__simple__set_tun_fd_impl(port, ptr, rust_vec_len, data_len),
        77 => wire__crate__api__astral_wfp__to_wide_string_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for FrbWrapper<GUID> {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(self.0)
            .into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for FrbWrapper<GUID> {}

impl flutter_rust_bridge::IntoIntoDart<FrbWrapper<GUID>> for GUID {
    fn into_into_dart(self) -> FrbWrapper<GUID> {
        self.into()
    }
}
...
impl SseEncode for GUID {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<GUID>>>::sse_encode(
...
impl SseEncode for Vec<GUID> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <GUID>::sse_encode(item, serializer);
        }
    }
}
